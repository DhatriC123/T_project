...
<div class="row">
    <div class="column">
   <button style={{background:'black'}}> <img src={si1} id="si1" alt=" Snow" style={{width:'80%'}}/></button>
   
      <h3 style={{color:'white'}}> Stebin Ben Live in Concert</h3>
      <figcaption >Nov 30: Phoenix MarketCity</figcaption>
    </div>
    <div class="column">
    <button style={{background:'black'}}><img src={si2} alt=" Snow" style={{width:'80%'}}/></button>
      <h3 style={{color:'white'}}> Supermoon ft. B Praak -King of Hearts Tour</h3>
      <figcaption>Nov 8: Orion Mall</figcaption>
    </div>
    <div class="column">
    <button style={{background:'black'}}><img src={si3} alt=" Snow" style={{width:'80%'}} height="305"/></button>
    <h3 style={{color:'white'}}>Armaan Malik India Tour </h3>
      <figcaption>Nov 20: UB City Amphitheatre</figcaption>
    </div>
</div>
...
<div class="row">
    <div class="column">
    <button style={{background:'black'}} ><img src={si4} alt="Snow" style={{width:'80%'}} height="370"/></button>
      <h3 style={{color:'white'}}> Emiway Bantai Live</h3>
      <figcaption>Nov 26: Phoenix MarketCity</figcaption>
    </div>
    <div class="column">
    <button style={{background:'black'}}><img src={si5} alt="Snow" style={{width:'80%'}}height="370"/></button>
      <h3 style={{color:'white'}}> DJ Snake</h3>
      <figcaption>Nov 27: Bengaluru International Exhibition Centre</figcaption>
    </div>
    <div class="column">
    <button style={{background:'black'}}><img src={si6} alt="Snow" style={{width:'80%'}} height="370"/></button>
